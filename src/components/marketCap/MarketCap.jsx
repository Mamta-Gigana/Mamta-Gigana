        ...
        <div>
            ...
            {/* {
                currentItems.map((data) => {
                    ...
                    return (
                        <div key={data.name} className="loading flex justify-between py-8" style={{ borderBottom: '0.5px solid #dbdbdb' }}>
                            <div>
                                <p className="description font-bold text-lg lg:text-xl">{data.name}</p>
                                <p className="description font-semibold text-gray-600 text-base lg:text-lg">Mkt.Cap <span>
                                    {symbol}
                                    {numberWithCommas(
                            ...
                            <div className="description w-24">
                                {
                                    profit ? (
